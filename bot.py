...
# ---------- Tayyor fitnes sarlavhalar (AI emas, bepul) ----------
import random

READY_CAPTIONS = [
    ("Build a Stronger Back 🔥", "Train your back the right way. Save this for your next session!"),
    ("Core Workout You Need 💪", "Hit your abs with this killer move. Try it today!"),
    ("Train Smarter, Not Harder 🔥", "Perfect form = better results. Watch closely!"),
    ("Chest Day Essentials 💪", "Build a powerful chest with this exercise. Save it!"),
    ("Leg Day Done Right 🔥", "Don't skip leg day! Master this movement."),
    ("Shoulder Strength Secrets 💪", "Grow stronger shoulders with proper form."),
    ("Stop Doing This Wrong ⚠️", "Fix your form and protect your joints. Watch till the end!"),
    ("Best Move for Your Abs 🔥", "Sculpt your core with this exercise. Try it now!"),
    ("Glutes & Hamstrings 💪", "Build your lower body the smart way."),
    ("Perfect Your Form 🔥", "Small fixes, big results. Save this one!"),
    ("Biceps Builder 💪", "Grow your arms with this proven move."),
    ("Full Body Burn 🔥", "Hit every muscle with this routine. Let's go!"),
    ("Protect Your Spine ⚠️", "Avoid injury with the correct technique."),
    ("Upper Body Power 💪", "Build serious strength up top. Save it!"),
    ("The Right Way to Train 🔥", "Form over everything. Watch and learn!"),
    ("Strengthen Your Core 💪", "A strong core changes everything. Try this!"),
    ("Back Gains Unlocked 🔥", "Master this for a wider, stronger back."),
    ("Chest Pump Guaranteed 💪", "Feel the burn with this chest exercise!"),
    ("Level Up Your Legs 🔥", "Stronger legs start here. Save this move!"),
    ("Anatomy of a Perfect Rep 💪", "See exactly which muscles work. Learn the science!"),
    ("Don't Make This Mistake ⚠️", "Common gym error explained. Watch closely!"),
    ("Sculpt Your Shoulders 🔥", "Build boulder shoulders the right way."),
    ("Abs of Steel 💪", "Train your core like a pro. Try it today!"),
    ("Master This Movement 🔥", "Technique is everything. Save for later!"),
    ("Grow Your Back 💪", "Wider back, stronger you. Let's train!"),
    ("Fix Your Posture 🔥", "Better posture starts with these muscles."),
    ("Power Through Legs 💪", "Explosive leg strength explained!"),
    ("Train Like You Mean It 🔥", "Give it everything. Save this workout!"),
    ("The Science of Strength 💪", "Understand your muscles, train smarter."),
    ("Next Level Gains 🔥", "Take your training up a notch. Try this!"),
]


def pick_caption():
    """Tasodifiy tayyor sarlavha tanlaydi."""
    title, desc = random.choice(READY_CAPTIONS)
    tags = "#fitness #workout #gym #anatomy #training #motivation"
    full_title = f"{title} {tags}"
    full_desc = f"{desc}\n\n{tags}"
    return full_title[:100], full_desc
...
async def handle_video(message: types.Message):
    ...
    # caption bor bo'lsa o'shani ishlatamiz, yo'q bo'lsa tayyor sarlavha
    ...
    if caption:
        ...
        title, description = pick_caption()
